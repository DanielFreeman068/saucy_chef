      ...
      <div className="w-full md:w-2/3 flex flex-col justify-center items-center bg-white">
        ...
        <form onSubmit={handleSubmit} className="w-80">
          ...
          <input
            ...
            className="w-full py-2 px-3 mb-4 border border-gray-300 rounded-sm bg-white shadow-sm focus:ring-2 focus:ring-blue-400 focus:outline-none transition duration-200"
          ...
          <button
            type="submit"
            className="w-full p-2 mt-6 bg-[#7F0B04] text-white rounded-sm hover:bg-hl-blue transition"
          >
            {isLogin ? 'Login' : 'Sign Up'}
          </button>
        </form>
